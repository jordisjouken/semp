!function(t) {
        ...
        function o() {
            if (!u) {
                ...
                if (h = function() {
                    ...
                    r.appendChild(o);
                    var a = h(o);
                    d = 200 === e(a.width), r.removeChild(o)
                }
            }
        }
        function a(t) {
            if (o(), "string" == typeof t && (t = document.querySelector(t)), t && "object" == typeof t && t.nodeType) {
                ...
                for (var a = s.isBorderBox = !(!c || !i[c] || "border-box" !== i[c]), u = 0, p = r.length; p > u; u++) {
                    var f = r[u],
                        v = i[f];
                    v = l(t, v);
                    var g = parseFloat(v);
                ...
                var m = s.paddingLeft + s.paddingRight,
                    ...
                    x = a && d,
                    C = e(i.width);
                C !== !1 && (s.width = C + (x ? 0 : m + S));
                var _ = e(i.height);
                return _ !== !1 && (s.height = _ + (x ? 0 : y + E)), s.innerWidth = s.width - (m + S), s.innerHeight = s.height - (y + E), s.outerWidth = s.width + b, s.outerHeight = s.height + w, s
            }
        }
        function l(e, i) {
    ...
    return n.htmlInit = function(i, o) {
        e(function() {
            for (var e = (n.toDashed(o), document.querySelectorAll(".slideshow")), r = "data-slideshow-options", a = 0, l = e.length; l > a; a++) {
                var h,
                    c = e[a],
                    d = c.getAttribute(r);
                try {
                    ...
                    s && s.error("Error parsing " + r + " on " + c.nodeName.toLowerCase() + (c.id ? "#" + c.id : "") + ": " + u);
                    continue
                }
                var p = new i(c, h),
                    f = t.jQuery;
    ...
    for (var n, o = 0, s = "webkit moz ms o".split(" "), r = t.requestAnimationFrame, a = t.cancelAnimationFrame, l = 0; l < s.length && (!r || !a); l++)
        n = s[l], r = r || t[n + "RequestAnimationFrame"], a = a || t[n + "CancelAnimationFrame"] || t[n + "CancelRequestAnimationFrame"];
    r && a || (r = function(e) {
    ...
    if ("function" == typeof define && define.amd)
        define("flickity/js/flickity", ["classie/classie", "eventEmitter/EventEmitter", "eventie/eventie", "get-size/get-size", "fizzy-ui-utils/utils", "./cell", "./animate"], function(i, n, o, s, r, a, l) {
            return e(t, i, n, o, s, r, a, l)
        });
...
}(window, function(t, e, i, n, o, s, r, a) {
    function l(t, e) {
    ...
    function h(t, e) {
        ...
        return i ? (this.element = i, c && (this.$element = c(this.element)), this.options = s.extend({}, this.constructor.defaults), this.option(e), void this._create()) : void (u && u.error("Bad element for Flickity: " + (i || t)))
    }
    var c = t.jQuery,
    ...
    h.defaults = {
        ...
        if (!this.isActive) {
            this.isActive = !0, e.add(this.element, "slideshow--enabled"), this.options.rightToLeft && e.add(this.element, "slideshow--rtl"), this.getSize();
        ...
        t.className = "slideshow__slider", t.style[this.originSide] = 0, this.slider = t
        ...
        for (var n, o = this.cells.length, s = t; o > s; s++)
            n = this.cells[s], n.setPosition(e), e += n.size.outerWidth, this.maxCellHeight = Math.max(n.size.outerHeight, this.maxCellHeight);
    ...
    h.prototype.setCellAlign = function() {
        ...
        if (this.options.contain && !this.options.wrapAround && this.cells.length)
            for (var t = this.options.rightToLeft ? "marginRight" : "marginLeft", e = this.options.rightToLeft ? "marginLeft" : "marginRight", i = this.cells[0].size[t], n = this.getLastCell(), o = this.slideableWidth - n.size[e], s = o - this.size.innerWidth * (1 - this.cellAlign), r = o < this.size.innerWidth, a = 0, l = this.cells.length; l > a; a++) {
                var h = this.cells[a];
                h.setDefaultTarget(), r ? h.target = o * this.cellAlign : (h.target = Math.max(h.target, this.cursorPosition + i), h.target = Math.min(h.target, s))
            }
        ...
        this._removeSelectedCellClass(), this.selectedCell = this.cells[this.selectedIndex], this.selectedElement = this.selectedCell.element, e.add(this.selectedElement, "slideshow__slide--selected")
    }, h.prototype._removeSelectedCellClass = function() {
        this.selectedCell && e.remove(this.selectedCell.element, "slideshow__slide--selected")
        ...
        return e ? e : (t = s.getParent(t, ".slideshow__slider > *"), this.getCell(t))
    ...
    h.prototype.watchCSS = function() {
        ...
        if (this.isActive) {
            e.remove(this.element, "slideshow--enabled"), e.remove(this.element, "slideshow--rtl");
    ...
    return h.setUnselectable = function(t) {
        ...
        return e && f[e]
    }, s.htmlInit(h, "flickity"), c && c.bridget && c.bridget("flickity", h), h.Cell = r, h
}), function(t, e) {
    "use strict";
    ...
    return o.prototype._bindPostStartEvents = function(e) {
        if (e) {
            for (var n = s[e.type], o = e.preventDefault ? t : document, r = 0, a = n.length; a > r; r++) {
                var l = n[r];
                i.bind(o, l, this)
            }
    ...
    s.prototype._bindHandles = function(t) {
        ...
        for (var n = t ? "bind" : "unbind", o = 0, s = this.handles.length; s > o; o++) {
    ...
    s.prototype.pointerDown = function(i, n) {
        ...
        o && o.blur && o.blur(), this._bindPostStartEvents(i), this.pointerDownScroll = s.getScrollPosition(), e.bind(t, "scroll", this), this.emitEvent("pointerDown", [i, n])
    ...
    "use strict";
    "function" == typeof define && define.amd ? define("flickity/js/drag", ["classie/classie", "eventie/eventie", "./flickity", "unidragger/unidragger", "fizzy-ui-utils/utils"], function(i, n, o, s, r) {
    ...
    }), n.createMethods.push("_createDrag"), s.extend(n.prototype, o.prototype), n.prototype._createDrag = function() {
        this.on("activate", this.bindDrag), this.on("uiChange", this._uiChangeDrag), this.on("childUIPointerDown", this._childUIPointerDownDrag), this.on("deactivate", this.unbindDrag)
    }, n.prototype.bindDrag = function() {
        this.options.draggable && !this.isDragBound && (e.add(this.element, "slideshow--draggable"), this.handles = [this.viewport], this.bindHandles(), this.isDragBound = !0)
    }, n.prototype.unbindDrag = function() {
        this.isDragBound && (e.remove(this.element, "slideshow--draggable"), this.unbindHandles(), delete this.isDragBound)
    }, n.prototype._uiChangeDrag = function() {
        delete this.isFreeScrolling
    }, n.prototype._childUIPointerDownDrag = function(t) {
        r(t), this.pointerDownFocus(t)
    }, n.prototype.pointerDown = function(n, s) {
        if ("INPUT" == n.target.nodeName && "range" == n.target.type)
            return this.isPointerDown = !1, void delete this.pointerIdentifier;
        this._dragPointerDown(n, s);
        var r = document.activeElement;
        r && r.blur && r != this.element && r != document.body && r.blur(), this.pointerDownFocus(n), this.dragX = this.x, e.add(this.viewport, "slideshow__viewport--dragging"), this._bindPostStartEvents(n), this.pointerDownScroll = o.getScrollPosition(), i.bind(t, "scroll", this), this.dispatchEvent("pointerDown", n, [s])
    };
    var l = {
            touchstart: !0,
            MSPointerDown: !0
    ...
    return n.prototype.touchVerticalScrollMove = function(e, i, n) {
        var o = this.options.touchVerticalScroll,
            s = "withDrag" == o ? !o : this.isDragging || !o;
        ...
        r(t), this.previousDragX = this.dragX;
        ...
        for (var n = this.selectedIndex, o = 1 / 0, s = this.options.contain && !this.options.wrapAround ? function(t, e) {
                ...
                return e > t
            }; s(e, o) && (n += i, o = e, e = this.getCellDistance(-t, n), null !== e);)
            e = Math.abs(e);
        return {
            distance: o,
            index: n - i
    ...
    return n.prototype.pointerUp = function(i, n) {
        var o = e.getPointerPoint(n),
            ...
            h = o.x >= r.left + a && o.x <= r.right + a && o.y >= r.top + l && o.y <= r.bottom + l;
    ...
    "use strict";
    "function" == typeof define && define.amd ? define("flickity/js/prev-next-button", ["eventie/eventie", "./flickity", "tap-listener/tap-listener", "fizzy-ui-utils/utils"], function(i, n, o, s) {
        return e(t, i, n, o, s)
    ...
    return s.prototype = new n, s.prototype._create = function() {
        ...
        if (e.className = "slideshow__button", e.className += this.isPrevious ? " slideshow__button--previous" : " slideshow__button--next", e.setAttribute("type", "button"), this.disable(), i.setUnselectable(e), l()) {
            var n = this.createSVG();
            e.appendChild(n)
        } else
            this.setArrowText(), e.className += " slideshow__button--no-svg";
        var o = this;
        ...
        return e.setAttribute("d", i), e.setAttribute("class", "slideshow__arrow"), this.isLeft || e.setAttribute("transform", "translate(100, 100) rotate(180) "), t.appendChild(e), t
    ...
    "use strict";
    "function" == typeof define && define.amd ? define("flickity/js/page-dots", ["eventie/eventie", "./flickity", "tap-listener/tap-listener", "fizzy-ui-utils/utils"], function(i, n, o, s) {
        return e(t, i, n, o, s)
    }) : "object" == typeof exports ? module.exports = e(t, require("eventie"), require("./flickity"), require("tap-listener"), require("fizzy-ui-utils")) : e(t, t.eventie, t.Flickity, t.TapListener, t.fizzyUIUtils)
}(window, function(t, e, i, n, o) {
    function s(t) {
    ...
    return s.prototype = new n, s.prototype._create = function() {
        this.holder = document.createElement("ol"), this.holder.className = "slideshow__page-dots", i.setUnselectable(this.holder), this.dots = [];
        var t = this;
        this.onCellSelect = function() {
            t.updateSelected()
        ...
        for (var e = document.createDocumentFragment(), i = []; t;) {
            ...
            n.className = "slideshow__dot", e.appendChild(n), i.push(n), t--
        }
        ...
        this.selectedDot && (this.selectedDot.className = "slideshow__dot"), this.dots.length && (this.selectedDot = this.dots[this.parent.selectedIndex], this.selectedDot.className = "slideshow__dot slideshow__dot--selected")
        ...
        this.deactivate()
    }, i.PageDots = s, o.extend(i.defaults, {
        pageDots: !0
    ...
    var s,
        r;
    return "hidden" in document ? (s = "hidden", r = "visibilitychange") : "webkitHidden" in document && (s = "webkitHidden", r = "webkitvisibilitychange"), o.prototype = new t, o.prototype.play = function() {
    ...
    return e.prototype.insert = function(t, e) {
        ...
        for (e = 0, n = s.length; n > e; e++)
            o = s[e], o.remove(), i.removeFrom(this.cells, o);
    ...
    "use strict";
    "function" == typeof define && define.amd ? define("flickity/js/lazyload", ["classie/classie", "eventie/eventie", "./flickity", "fizzy-ui-utils/utils"], function(i, n, o, s) {
        return e(t, i, n, o, s)
    ...
    }, r.prototype.complete = function(t, n) {
...
"document" in self && ("classList" in document.createElement("_") ? !function() {
    ...
    if ("Element" in t) {
        var e = "classList",
            ...
            h = function(t) {
                for (var e = s.call(t.getAttribute("class") || ""), i = e ? e.split(/\s+/) : [], n = 0, o = i.length; o > n; n++)
                    this.push(i[n]);
        ...
        if (a[i] = Error[i], c.item = function(t) {
            return this[t] || null
            ...
            var t,
                ...
                n = e.length,
                o = !1;
            do t = e[i] + "", -1 === l(this, t) && (this.push(t), o = !0);
            while (++i < n);
            ...
            var t,
                ...
                o = i.length,
                s = !1;
            do for (t = i[n] + "", e = l(this, t); -1 !== e;)
                this.splice(e, 1), s = !0, e = l(this, t);
            while (++n < o);
            ...
            try {
                o.defineProperty(n, e, u)
            } catch (p) {
                -2146823252 === p.number && (u.enumerable = !1, o.defineProperty(n, e, u))
            }
        } else
            o[i].__defineGetter__ && n.__defineGetter__(e, d)
    }
}(self));
!function(t) {
    if ("object" == typeof exports && "undefined" != typeof module)
        ...
        var e;
        e = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof self ? self : this, e.Luminous = t()
    }
}(function() {
    return function t(e, i, n) {
        ...
        1: [function(t, e, i) {
            ...
            var r = t("./util/dom"),
                a = t("./util/throwIfMissing"),
                l = n(a),
                h = "undefined" == typeof document ? !1 : "animation" in document.createElement("div").style,
                c = function() {
                    function t() {
                        var e = this,
                            i = arguments.length <= 0 || void 0 === arguments[0] ? {} : arguments[0];
                        o(this, t), this._sizeImgWrapperEl = function() {
                            var t = e.imgWrapperEl.style;
                            t.width = e.innerEl.clientWidth + "px", t.height = e.innerEl.clientHeight - e.captionEl.clientHeight + "px"
                        }, this._completeOpen = function() {
                            e.el.removeEventListener("animationend", e._completeOpen, !1), (0, r.removeClasses)(e.el, e.openingClasses)
                        }, this._completeClose = function() {
                            e.el.removeEventListener("animationend", e._completeClose, !1), (0, r.removeClasses)(e.el, e.openClasses), (0, r.removeClasses)(e.el, e.closingClasses)
                        };
                        var n = i.namespace,
                            s = void 0 === n ? null : n,
                            a = i.parentEl,
                            h = void 0 === a ? (0, l["default"])() : a,
                            c = i.triggerEl,
                            u = void 0 === c ? (0, l["default"])() : c,
                            d = i.sourceAttribute,
                            p = void 0 === d ? (0, l["default"])() : d,
                            f = i.captionAttribute,
                            v = void 0 === f ? (0, l["default"])() : f,
                            g = i.includeImgixJSClass,
                            m = void 0 === g ? !1 : g;
                        if (this.settings = {
                            namespace: s,
                            parentEl: h,
                        ...
                        }, !(0, r.isDOMElement)(this.settings.parentEl))
                            throw new TypeError("`new Lightbox` requires a DOM element passed as `parentEl`.");
                        this.openClasses = this._buildClasses("open"), this.openingClasses = this._buildClasses("opening"), this.closingClasses = this._buildClasses("closing"), this.elementBuilt = !1
                    }
                    return s(t, [{
                        key: "_buildClasses",
                        value: function(t) {
                        ...
                        key: "_buildElement",
                        value: function() {
                            this.el = document.createElement("div"), (0, r.addClasses)(this.el, this._buildClasses("lightbox")), this.innerEl = document.createElement("div"), (0, r.addClasses)(this.innerEl, this._buildClasses("lightbox-inner")), this.el.appendChild(this.innerEl);
                            var t = document.createElement("div");
                            (0, r.addClasses)(t, this._buildClasses("lightbox-loader")), this.innerEl.appendChild(t), this.imgWrapperEl = document.createElement("div"), (0, r.addClasses)(this.imgWrapperEl, this._buildClasses("lightbox-image-wrapper")), this.innerEl.appendChild(this.imgWrapperEl);
                            var e = document.createElement("span");
                            (0, r.addClasses)(e, this._buildClasses("lightbox-position-helper")), this.imgWrapperEl.appendChild(e), this.imgEl = document.createElement("img");
                            var i = this.imgEl;
                            this.imgEl.addEventListener("load", function() {
                                this.complete && e.appendChild(i)
                            }), this.captionEl = document.createElement("p"), (0, r.addClasses)(this.captionEl, this._buildClasses("lightbox-caption")), e.appendChild(this.captionEl), this.settings.parentEl.appendChild(this.el), this._updateImgSrc(), this._updateCaption(), this.settings.includeImgixJSClass && this.imgEl.classList.add("imgix-fluid")
                        }
                    }, {
                        key: "_updateCaption",
                        value: function() {
                            var t = this.settings.captionAttribute;
                            t && (this.captionEl.innerText = this.settings.triggerEl.getAttribute(t))
                        }
                    }, {
                        key: "_updateImgSrc",
                        value: function() {
                            var t = this.settings.triggerEl.getAttribute(this.settings.sourceAttribute);
                            if (!t)
                        ...
                        key: "open",
                        value: function() {
                            this.elementBuilt || (this._buildElement(), this.elementBuilt = !0), this._updateImgSrc(), this._updateCaption(), (0, r.addClasses)(this.el, this.openClasses), this._sizeImgWrapperEl(), window.addEventListener("resize", this._sizeImgWrapperEl, !1), h && (this.el.addEventListener("animationend", this._completeOpen, !1), (0, r.addClasses)(this.el, this.openingClasses))
                        }
                    }, {
                        key: "close",
                        value: function() {
                            window.removeEventListener("resize", this._sizeImgWrapperEl, !1), h ? (this.el.addEventListener("animationend", this._completeClose, !1), (0, r.addClasses)(this.el, this.closingClasses)) : (0, r.removeClasses)(this.el, this.openClasses)
                        }
                    }, {
                        key: "destroy",
                        value: function() {
        ...
        2: [function(t, e) {
            ...
            e.exports = (s = o = function() {
                function t(e) {
                    ...
                    if (n(this, t), r.call(this), this.isOpen = !1, this.trigger = e, !(0, l.isDOMElement)(this.trigger))
                        throw new TypeError("`new Luminous` requires a DOM element as its first argument.");
                    var o = i.namespace,
                        s = void 0 === o ? null : o,
                        a = i.sourceAttribute,
                        h = void 0 === a ? "href" : a,
                        u = i.captionAttribute,
                        d = void 0 === u ? null : u,
                        p = i.openTrigger,
                        f = void 0 === p ? "click" : p,
                        v = i.closeTrigger,
                        ...
                        b = i.closeOnScroll,
                        w = void 0 === b ? !1 : b,
                        S = i.appendToSelector,
                        E = void 0 === S ? "body" : S,
                        x = i.onOpen,
                        C = void 0 === x ? null : x,
                        _ = i.onClose,
                        P = void 0 === _ ? null : _,
                        D = i.includeImgixJSClass,
                        k = void 0 === D ? !1 : D,
                        A = i.injectBaseStyles,
                        z = void 0 === A ? !0 : A;
                    this.settings = {
                        namespace: s,
                        sourceAttribute: h,
                        ...
                        onOpen: C,
                        onClose: P,
                        includeImgixJSClass: k,
                        injectBaseStyles: z
                    }, this.settings.injectBaseStyles && (0, c["default"])(), this._buildLightbox(), this._bindEvents()
                }
                return a(t, [{
                    key: "_buildLightbox",
                    value: function() {
                        this.lightbox = new d["default"]({
                    ...
                    key: "_unbindEvents",
                    value: function() {
                        this.trigger.removeEventListener(this.settings.openTrigger, this.open, !1), this.lightbox.el.removeEventListener(this.settings.closeTrigger, this.close, !1), this.settings.closeWithEscape && window.removeEventListener("keyup", this._handleKeyup, !1)
                    }
                }]), t
            }(), r = function() {
                var t = this;
                this.VERSION = "0.2.4", this.open = function(e) {
                    e && "function" == typeof e.preventDefault && e.preventDefault();
                    var i = t.lightbox.elementBuilt;
                    t.lightbox.open(), i || t._bindCloseEvent(), t.settings.closeOnScroll && window.addEventListener("scroll", t.close, !1);
                    var n = t.settings.onOpen;
                    n && "function" == typeof n && n(), t.isOpen = !0
                }, this.close = function(e) {
                    e && "function" == typeof e.preventDefault && e.preventDefault(), t.settings.closeOnScroll && window.removeEventListener("scroll", t.close, !1), t.lightbox.close();
                    var i = t.settings.onClose;
                    i && "function" == typeof i && i(), t.isOpen = !1
                }, this._handleKeyup = function(e) {
                    t.isOpen && 27 === e.keyCode && t.close()
                }, this.destroy = function() {
                    t._unbindEvents(), t.lightbox.destroy()
                }
            }, s)
        }, {
            "./Lightbox": 1,
            "./injectBaseStylesheet": 3,
            "./util/dom": 4
        }],
        3: [function(t, e, i) {
            "use strict";
            function n() {
                if (!document.querySelector(".lum-base-styles")) {
                    ...
                    t.type = "text/css", t.classList.add("lum-base-styles"), t.appendChild(document.createTextNode(o));
                    var e = document.head;
        ...
        4: [function(t, e, i) {
            ...
            function o(t) {
                return a ? t instanceof HTMLElement : t && "object" === ("undefined" == typeof t ? "undefined" : n(t)) && null !== t && 1 === t.nodeType && "string" == typeof t.nodeName
            }
            function s(t, e) {
            ...
            Object.defineProperty(i, "__esModule", {
                value: !0
            }), i.isDOMElement = o, i.addClasses = s, i.removeClasses = r;
            var a = "object" === ("undefined" == typeof HTMLElement ? "undefined" : n(HTMLElement))
        }, {}],
        5: [function(t, e, i) {
            "use strict";
            function n() {
